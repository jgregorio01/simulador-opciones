...
# --- MODIFICADO: Rango de Volatilidad hasta 1000% ---
IV = st.sidebar.slider("Volatilidad Implícita (IV %)", 1.0, 1000.0, 20.0)
...
with tab3:
    # --- MODIFICADO: Gráfica abarca hasta 1000% IV ---
    vol_range = np.linspace(1, 1000, 100)
    ...
    fig_vega.update_layout(title="Impacto de Volatilidad (0% a 1000%)", xaxis_title="Volatilidad (%)", yaxis_title="Precio")
